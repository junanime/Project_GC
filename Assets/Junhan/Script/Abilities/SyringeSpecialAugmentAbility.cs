    ...
    public class SyringeSpecialAugmentAbility : Ability
    {
        ...
        private string NewEffectDescription()
        {
            switch(augmentType)
            {
                ...
                case SpecialAugmentType.IceNeedle: return "적중마다 냉기 1스택. 원본 속도 대비 1·2·3스택에서 20%·30%·40% 감속. 4번째 적중에 확정 5초 빙결, 매 적중 10% 확률로 즉시 빙결. 빙결 시 스택 소모. 다음 침 적중 피해 +20% 후 해제. 보스는 빙결 대신 감속.";
