...
namespace Vampire
{
    ...
    public class DigestiveAcidPuddle : MonoBehaviour
    {
        ...
        private void UpdateVisual()
        {
            ...
            RebuildCircle(outerLine, radius * pulse);
            RebuildCircle(innerLine, radius * 0.55f * Mathf.Lerp(0.85f, 1.15f, Mathf.PingPong(Time.time * 1.8f, 1f)));

            SetAlpha(outerLine, puddleColor.a * remainingRatio);
            SetAlpha(innerLine, puddleColor.a * 0.65f * remainingRatio);
        }
