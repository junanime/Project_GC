    ...
    public class RangedMonster : Monster
    {
            ...
            float hpBuff = 0)
        {
            ...
            this.monsterBlueprint =
                (RangedMonsterBlueprint)monsterBlueprint;

            projectileIndex =
                entityManager.AddPoolForProjectile(
                    this.monsterBlueprint.projectilePrefab
                );
            ...
            if (alive)
            {
                ...
                switch (state)
                {
                    ...
                    case State.Shooting:
                        ...
                        if (outOfRangeTime >
                            monsterBlueprint.timeAllowedOutsideRange)
                        {
                            state = State.Walking;
        ...
        protected void LaunchProjectile(Vector2 direction)
        {
            Projectile projectile =
                entityManager.SpawnProjectile(
                    ...
                    0,
                    monsterBlueprint.projectileSpeed,
            ...
            {
                Debug.LogWarning(
                    $"[RangedMonster] SpawnProjectile 실패 | " +
            ...
            projectile.SetSourceMonster(monsterBlueprint);
